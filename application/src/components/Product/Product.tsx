    ...
    return (
        <div className='product'>
            ...
            <div className={`product-details ${isEditing ? 'product-edit' : ''}`}>
                ...
                <span className='product-detail-common product-detail-bold'>Описание: </span>
                <span className='product-detail-common product-detail_desc'>{product.description}</span>
